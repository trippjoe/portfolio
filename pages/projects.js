import { Flex, SimpleGrid, Box, Button, Heading, VStack, Image, Link } from '@chakra-ui/react';
            ...
            <Flex minH="80vh" maxH="80vh" justify="center" alignSelf="center">
                <SimpleGrid columns={[1, 1, 2, 3]} spacing="9" overflowY={"scroll"}>
                    {projects.map((project) => (
                        <Box key={project.name} textAlign="center" maxW="sm" backgroundColor="#AD7A40" borderRadius="lg" p="3" shadow="xl">
